...
if TriSeg.switch
    ...
    TriSeg.Ischemic(scars(iScarCase).pattern) = 1;
...
% compartments by average literature blood volume. Will be overwritten if
% previously converged solution exists (in ConSol)
...
% Plot parameters
plotSwitchg = false;                                 % Make plots?
plotParsg.fSize = 18;                               % Font size
plotParsg.lWidth = 3;                               % Line width
plotParsg.mSize = 8;                                % Marker size
plotParsg.cMapName = 'parula';                      % Colormap: parula, viridis, magma, plasma, inferno, or any Colorbrewer map
