...
A = 0.210;                % Linear ED component [mmHg]
B = 0.108;                % Exponential ED component [1/mL] 
LVEes = 17.0;               % End-systolic elastance of LV [mmHg/mL]
V0 = 13.1;                 % End-systolic elastance of LV [mmHg/mL]
...
SBVg = [356; repmat(347, [Ng-1 1])];
Rasg = [2.25; repmat(1.87, [Ng-1 1])];
maxpdivco = MAP_vector./CO_vector * 60/1000;
ratioval = Rasg(2) / maxpdivco(2); %dividing the acute values at day 0 of growth
