...
% Vignesh Valaboju -- Replication of Witzenberg 2018 Volume Overload
...
SBV = 464.0;           % Stresses blood volume for Vernooy (fit 5) - acute change x0.95
...
A = 0.145;                % Linear ED component [mmHg]
B = 0.089;                % Exponential ED component [1/mL] 
LVEes = 26.6;               % End-systolic elastance of LV [mmHg/mL]
V0 = 26.4;                 % End-systolic elastance of LV [mmHg/mL]
...
tTotal = 90;              % Total simulation time [days]
...
SBVg = [338; repmat(390, [Ng-1 1])];
Rasg = [2.38; repmat(2.2733, [Ng-1 1])];
MVBRg = [inf linspace(0.1479, 0.1479*1.4, 91)];
HRg = [62, HR_vector]; %HR_vector from Nakano_Data.mat. It is experimental data
